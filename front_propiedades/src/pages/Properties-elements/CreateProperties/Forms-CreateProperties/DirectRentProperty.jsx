...
const DirectRentPropertyForm = () => {
    ...
    return (
      <div id='InmRentProperty-Table' className='container-GI'>
        <div className='container-fluid'>
          <div className='subtitle-font forms-title'>Información - Rentado Directo</div>
            
            <div className='row row-elements'>
                <div className='col-3'>
                    <div className='subheader-font'>Arrendador</div>
                    <select
                        name="lessor"
                        className='button-font dropdown'
                        value={formValues.lessor}
                        onChange={handleChange}
                    >
                        <option value="">Selecciona</option>
                        <option value="apartment">Arrendadores varios</option>
                    </select>
                </div>
                <div className='col-3'>
  ...
  export default DirectRentPropertyForm;